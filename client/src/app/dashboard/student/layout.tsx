...
import { faChartPie, faUser, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
export default function StudentDashboardLayout({
  ...
  const tabs = [
    { name: 'Overview', href: '/dashboard/student/overview', icon: faChartPie },
    { name: 'Profile', href: '/dashboard/student/profile', icon: faUser }
  ]
      ...
      <nav className="w-72 mr-5 flex-shrink-0 bg-white border-r border-gray-100 flex flex-col">
        <div className="p-6">
          <div className="mb-8 px-4">
            <h2 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Student Portal</h2>
          </div>
